...
namespace DaytraderPlatformBackend.Migrations
{
    ...
    [Migration("20250520131836_AddNotidicationFields")]
    partial class AddNotidicationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DaytraderPlatformBackend.Entities.AddressEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DaytraderPlatformBackend.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<decimal?>("AutoTradeThreshold")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DaytraderPlatformBackend.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
